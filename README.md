...
- Gatsby.js [Gatsby.js](https://gatsbyjs.org)
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/hjjxr38s/settings/api) and create a token with read rights.
